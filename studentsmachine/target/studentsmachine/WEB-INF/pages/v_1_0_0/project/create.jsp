														    			...
														    			<div class="row">
														    				<div class="col-sm-6">
														    					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
																				    ...
																				    <label class="mdl-textfield__label" for="id"><smal >Project ID</smal></label>
														    				...
														    				<div class="col-sm-6">
														    					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
																				    <input name="projectName" class="mdl-textfield__input" type="text" id="projectName">
																				    <label class="mdl-textfield__label" for="projectName"><smal >Project Name</smal></label>
																				  </div>
														    				</div>
														    			</div>
														    			<br/>
														    	...
														    	<div class="row">
														    		<div class="col-sm-12">
														    			<div class="mdl-textfield mdl-js-textfield" style="width:100%;">
																		    <textarea name="content" class="mdl-textfield__input" type="text" rows= "10" id="content" style="background-color:#EAEDED;color:black;" ></textarea>
														    	...
														    	<!-- Left Content -->
														    		<div class="col-sm-6">
														    			<div class="row">
														    				<div class="col-sm-12">
														    					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
																				    <input name="version.versionNo" class="mdl-textfield__input" type="text" id="versionNo">
																				    <label class="mdl-textfield__label" for="versionNo"><smal >Version No</smal></label>
																				  </div>
														    				</div>
														    			</div>
														    			<br/>
														    		...
														    		<div class="col-sm-6">
														    			<div class="row" style="margin-left:4%">
														    				<div class="col-sm-12">
														    					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
																				    <input name="version.status.status" class="mdl-textfield__input" type="text" id="status">
																				    <label class="mdl-textfield__label" for="status"><smal >Version Status</smal></label>
																				  </div>
														    				</div>
