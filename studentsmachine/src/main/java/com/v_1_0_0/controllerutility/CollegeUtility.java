					...
					if( true ){
						try{
							if(data.getImageBase64()!=null){
								String dat = data.getImageBase64();
								String src = "data:image/png;base64,"+dat;
								map1.put("0",src);
							}else
								map1.put("0","not set");
						}catch(Exception ee){
						...
						if(data.getCode()!=null){
							map1.put("4",data.getCode());
						}else
							map1.put("4","not set");
						
						try{
							if(data.getFounderName()!=null){
								map1.put("5",data.getFounderName());
							}else
								map1.put("5","Not-Set");
						}catch(Exception ee){
						...
						try{
							if(data.getCreateInfo().getCreateAt()!=null){
								map1.put("6",data.getCreateInfo().getCreateAt());
							}else
								map1.put("6","not set");
						}catch(Exception ee){
							map1.put("6","Exception");
							ee.printStackTrace();
						}
						...
						try{
							...
							if(data.getCreateInfo().getCreateBy()!=null){
								map1.put("7",data.getCreateInfo().getCreateBy());
							}else
								map1.put("7","not set");
							
						}catch(Exception ee){
							map1.put("7","Exception");
							ee.printStackTrace();
						}
