 ...
 */
@Controller
public class StudentMachineController {
	 ...
	 * @throws IOException 
	 */
	@RequestMapping(value = { "/studentsmachine" }, method = RequestMethod.GET)
	public ModelAndView taskCreatePage(HttpServletResponse response, HttpServletRequest request) throws IOException {
		...
		response.sendRedirect("http://"+ip+":"+port+"/studentsmachine/collegeList");
		return null;
	}
}
