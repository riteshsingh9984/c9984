 ...
 * Generated at: 2016-05-12 10:23:52 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t  $(nRow).css('background-color', ' #669900')\r\n");
      out.write("\t\t\t\t  $(nRow).css('color', 'white')\r\n");
      out.write("\t\t\t\t  /* switch(aData[0]){\r\n");
      out.write("\t\t\t            case 'AAAA':\r\n");
      out.write("\t\t\t                $(nRow).css('color', 'red')\r\n");
      out.write("\t\t\t                break;\r\n");
      out.write("\t\t\t            case 'BBBB':\r\n");
      out.write("\t\t\t                $(nRow).css('color', 'green')\r\n");
      out.write("\t\t\t                break;\r\n");
      out.write("\t\t\t            case 'CCCC':\r\n");
      out.write("\t\t\t                $(nRow).css('color', 'blue')\r\n");
      out.write("\t\t\t                break;\r\n");
      out.write("\t\t\t        } */\r\n");
      out.write("\t\t\t    },  \r\n");
      ...
      out.write("\t\t\t\t  \t  \t        \t\tif (true) { \r\n");
      out.write("\t\t\t\t  \t  \t        \t\t\treturn '<img src=\"'+data[0]+'\" style=\"width:70px;height:70px;\" />';\r\n");
      ...
      out.write("\t\t\t  \t  \t        \t\t\"mRender\" : function (data, type, row) {\r\n");
      out.write("\t\t\t\t  \t  \t        \t\tif (true) { \r\n");
      out.write("\t\t\t\t  \t  \t        \t\t\treturn '<a style=\"color:black\" href=\"googlemap?id='+data[1]+'\">'+data[1]+'</a>';\r\n");
      out.write("\t\t\t\t  \t  \t        \t\t\t//return '<a style=\"color:blue;\" href=\"projectInfo?projectId='+data[0]+'\"><span >'+data[0]+'</span></a>';\r\n");
      out.write("\t\t\t\t  \t  \t        \t\t}\r\n");
      out.write("\t\t\t  \t  \t        \t\t}\r\n");
      out.write("\t  \t  \t        \t\t\t },\r\n");
      ...
      out.write("\t  \t  \t        \t\t\t      \t\t\t\treturn '<a class=\"mdl-shadow--16dp\" style=\"color:black;\" href=\"projectView?projectId='+data+'\"><span class=\"glyphicon glyphicon-eye-open\"></span></a>';\r\n");
      out.write("\t  \t  \t        \t\t\t      \t\t\t\t/*\r\n");
